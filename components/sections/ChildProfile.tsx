    ...
    <div className="w-full overflow-hidden rounded-card border border-border bg-surface">
      <div className="flex items-center gap-3 bg-ink p-4">
        ...
        <span className="flex flex-col">
          <span className="font-display font-bold text-[18px] text-cream">{child.name}</span>
          <span className="text-[13px] text-[#B9A6C4]">{child.age}</span>
        </span>
      </div>
      <dl className="flex flex-col gap-3 p-4">
        <div className="flex flex-col gap-0.5">
          <dt className="text-[12px] font-semibold text-ink-faint">Rotina</dt>
          <dd className="text-[14px] text-ink">{child.routine}</dd>
        </div>
        <div className="flex flex-col gap-0.5">
          <dt className="text-[12px] font-semibold text-ink-faint">Interesses</dt>
          <dd className="text-[14px] text-ink">{child.interests}</dd>
        </div>
        <div className="flex flex-col gap-0.5">
          <dt className="text-[12px] font-semibold text-ink-faint">Brincadeira recente</dt>
          <dd className="text-[14px] text-ink">{child.recentPlay}</dd>
        </div>
        <div className="flex flex-col gap-0.5">
          <dt className="text-[12px] font-semibold text-ink-faint">Observação dos pais</dt>
          <dd className="text-[14px] text-ink">{child.parentNote}</dd>
        </div>
      </dl>
    </div>
  );
  ...
  return (
    <section className="py-16">
      <Container className="flex flex-col gap-8">
        <h2 className="max-w-[36ch] text-title text-ink">{childProfile.title}</h2>
